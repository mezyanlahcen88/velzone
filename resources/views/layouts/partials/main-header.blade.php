            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img  src="{{URL::asset('storage/images/flags/'.App::getLocale().'.png')}}"  alt="" height="20" class="rounded">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">

                        <!-- item-->
                        {{-- @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="dropdown-item notify-item language py-2" data-lang="en"
                            title="English">
                            <img src="{{ URL::asset('storage/images/flags/'. $localeCode .'.png') }}" alt="user-image"
                                class="me-2 rounded" height="18">
                            <span class="align-middle">{{$properties['name']}}</span>
                        </a>
                        @endforeach --}}
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('storage/images/users/'.Auth::user()->picture) }}" alt="Header Avatar">
